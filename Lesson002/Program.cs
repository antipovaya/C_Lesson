...
void getNumberSquare (int x, int y){
...
if (a == y){
    ...
    if (b == x){
       Console.WriteLine($"Число {x} является квадратом {y}"); 
    }
    else{
        Console.WriteLine($"Число {x} и {y} не являются квадратами друг друга"); 
    }
}

}
getNumberSquare(num1, num2);
*/
